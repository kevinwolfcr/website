...
export function Glass() {
  ...
  return (
    <div className="fixed inset-0 z-10 flex pointer-events-none">
      <div className="absolute top-0 -translate-y-1/2 left-1/2 -translate-x-1/2 rounded-full w-[500px] aspect-square bg-accent-5" />
      <div className="absolute bottom-0 translate-y-1/2 left-0 -translate-x-1/2 rounded-full w-[500px] aspect-square bg-accent-5" />
      <div className="absolute bottom-0 translate-y-1/2 right-0 translate-x-1/2 rounded-full w-[500px] aspect-square bg-accent-4" />
